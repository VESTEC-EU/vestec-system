#!/bin/bash
export SSH_AUTH_SOCK=/tmp/com.apple.launchd.hWXgWlua6R/Listeners
...
/Library/Frameworks/Python.framework/Versions/3.7/bin/python3 /Users/bprodan/Documents/vestec/DecisionMaker/track_queue.py