...
def test_workflow(message):
    ...
    try:
        data_uuid=putByteDataViaDM("configuration.txt", "Blackdog", "simulation configuration file", "text/plain", "VESTEC autogenerated", data_blob, path=simulation.directory)
