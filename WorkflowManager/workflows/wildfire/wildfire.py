...
def wildfire_fire_simulation(msg):
    ...
    if hotspotDataUUID and weatherDataUUID is not None:
        ...
        try:
            ...
            sim_id=createSimulation(IncidentID, 1, "0:05:00", "Wildfire simulation", "wfa.sh", queuestate_callbacks=callbacks, template_dir="templates/wildfire_template", comment="Execution linked to hotspot data "+hotspotDataUUID)[0]
            with pny.db_session:
