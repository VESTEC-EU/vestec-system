...
def initialiseStaticInformation():
    ...
    archer = machine.Machine(machine_id=str(uuid4()), machine_name="ARCHER", host_name="login.archer.ac.uk", 
                            scheduler="PBS", num_nodes=4920, cores_per_node=24,base_work_dir="/work/d170/d170")
    cirrus = machine.Machine(machine_id=str(uuid4()), machine_name="CIRRUS", host_name="cirrus.epcc.ed.ac.uk", 
