...
def initialiseStaticInformation():
    ...
    archer = machine.Machine(name="ARCHER", hostname="login.archer.ac.uk", 
                            scheduler="PBS", numNodes=4920, coresPerNode=24,baseWorkdir="/work/d170/d170")
    cirrus = machine.Machine(name="Cirrus", hostname="cirrus.epcc.ed.ac.uk", 
                            scheduler="PBS", numNodes=280, coresPerNode=36,baseWorkdir="/lustre/home/????")
    # 
